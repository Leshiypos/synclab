                    ...
                    foreach( $my_posts as $post ){
                      ...
                      ?>
                        <div class="hero__slide swiper-slide">
                            ...
                            <video class="hero__slide-video hero__slide-video-<?php echo $i;?>" controls="controls" poster="<?php the_post_thumbnail_url('singl-video'); ?>" preload="none">
                            ...
                            <a class="play-btn play-btn-<?php echo $i;?>"></a>
                            </div>
                        </div>
                               <?php $i=$i+1;
                    }
        ...
        <section class="ReklamaBlog" id="ReklamaBlog">
            <div class="container">
                ...
                <!-- Окончание цикла постов Рекламы-->
                    ...
                    <a href="<?php echo esc_url(substr(get_page_link(9),0,-1)).'?category=advertising';?>" class="adv__block adv__block_last">
             ...
             <?php
                if (get_field('description_adv',2)){?>
                        <p class="text_descr"><?php the_field('description_adv',2); ?></p>
                <?php }
             ?>           
            </div>
        </section>
<!-- 
    Начало блока Сериалы
-->
        
        <section class="movies">
            <div class="container">
                <h2 class="serials__title adv__title title">Сериалы</h2>
                <div class="movies__socket adv__socket">
                    
                <!-- Начало цикла постов Сериалы-->
                <?php  
                // параметры по умолчанию
                    $my_posts = get_posts( array(
                        'numberposts' => 7,
                ...
                ?>
                    ...
                    wp_reset_postdata(); // сброс 
                ?> 
                <!-- Окончание цикла постов Сериалы-->    

                    <a href="<?php echo esc_url(substr(get_page_link(9),0,-1)).'?category=series_and_films';?>" class="adv__block adv__block_last">
                        Посмотреть все работы
                        <svg width="126" height="38" viewBox="0 0 126 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M3 16.5C1.61929 16.5 0.5 17.6193 0.5 19C0.5 20.3807 1.61929 21.5 3 21.5V16.5ZM124.768 20.7678C125.744 19.7915 125.744 18.2085 124.768 17.2322L108.858 1.32233C107.882 0.34602 106.299 0.34602 105.322 1.32233C104.346 2.29864 104.346 3.88155 105.322 4.85786L119.464 19L105.322 33.1421C104.346 34.1184 104.346 35.7014 105.322 36.6777C106.299 37.654 107.882 37.654 108.858 36.6777L124.768 20.7678ZM3 21.5H123V16.5H3V21.5Z" fill="#1D1A31"/>
                            </svg>
                ...
                <?php
                    if (get_field('description_ser',2)){?>
                            <p class="text_descr"><?php the_field('description_ser',2); ?></p>
                    <?php }
                ?>
            </div>
        </section>
...
<section class="movies">
            <div class="container">
                <h2 class="movies__title adv__title title">Кино</h2>
                <div class="movies__socket adv__socket">
                    
                <!-- Начало цикла постов кино-->
                <?php  
                // параметры по умолчанию
                    $my_posts = get_posts( array(
                        'numberposts' => 7,
                ...
                ?>
                    ...
                    wp_reset_postdata(); // сброс 
                ?> 
                <!-- Окончание цикла постов кино-->    

                    <a href="<?php echo esc_url(substr(get_page_link(9),0,-1)).'?category=films';?>" class="adv__block adv__block_last">
                        Посмотреть все работы
                        <svg width="126" height="38" viewBox="0 0 126 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M3 16.5C1.61929 16.5 0.5 17.6193 0.5 19C0.5 20.3807 1.61929 21.5 3 21.5V16.5ZM124.768 20.7678C125.744 19.7915 125.744 18.2085 124.768 17.2322L108.858 1.32233C107.882 0.34602 106.299 0.34602 105.322 1.32233C104.346 2.29864 104.346 3.88155 105.322 4.85786L119.464 19L105.322 33.1421C104.346 34.1184 104.346 35.7014 105.322 36.6777C106.299 37.654 107.882 37.654 108.858 36.6777L124.768 20.7678ZM3 21.5H123V16.5H3V21.5Z" fill="#1D1A31"/>
                            </svg>
                ...
                <?php
                    if (get_field('description_film',2)){?>
                            <p class="text_descr"><?php the_field('description_film',2); ?></p>
                    <?php }
                ?>
            </div>
        </section>
...
-->
                ...
                <?php if ($my_posts){?>
                    <a href="<?php echo esc_url(substr(get_page_link(9),0,-1)).'?category=music_prodaction';?>" class="adv__block adv__block_last">
                        Посмотреть все работы
                        <svg width="126" height="38" viewBox="0 0 126 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M3 16.5C1.61929 16.5 0.5 17.6193 0.5 19C0.5 20.3807 1.61929 21.5 3 21.5V16.5ZM124.768 20.7678C125.744 19.7915 125.744 18.2085 124.768 17.2322L108.858 1.32233C107.882 0.34602 106.299 0.34602 105.322 1.32233C104.346 2.29864 104.346 3.88155 105.322 4.85786L119.464 19L105.322 33.1421C104.346 34.1184 104.346 35.7014 105.322 36.6777C106.299 37.654 107.882 37.654 108.858 36.6777L124.768 20.7678ZM3 21.5H123V16.5H3V21.5Z" fill="#1D1A31"/>
                            </svg>
                ...
                <?php
                    if (get_field('description_mus',2)){?>
                            <p class="text_descr"><?php the_field('description_mus',2); ?></p>
                    <?php }
                ?>
            </div>
        </section>
        ...
        <section class="music-library">
            ...
            <div class="accordion-item">
                  <h2 class="accordion-header" id="heading<?php echo $id_butt;?>">
                    <button class="accordion-button collapsed music-library__block <?php the_field('color_block'); ?>" type="button" data-bs-toggle="collapse" data-bs-target="#collapse<?php echo $id_butt;?>" aria-expanded="true" aria-controls="collapse<?php echo $id_butt;?>">
                        
                            <img src="<?php echo the_post_thumbnail_url(); ?>" alt="logo">
                       
                    </button>
                  </h2>
                  <div id="collapse<?php echo $id_butt;?>" class="accordion-collapse collapse" aria-labelledby="heading<?php echo $id_butt;?>" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                      <div class="acc-block">
                        <h3 class="acc__title"><?php the_field('name_fon'); ?></h3>
                        <div class="acc-block-2">
                            <a class="acc__link" href="<?php the_field('website_synclab', 2); ?>"><?php the_field('website_synclab'); ?></a>
                            <span class="acc__count"><?php the_field('col_track'); ?></span>
                        </div>
                    </div>
                        <span class="acc__text">Описание фонотеки</span>
                        <p class="acc__paragraph"><?php the_field('descr_fon'); ?></p>
        ...
        <section class="rules" id="rules">
            <div class="container">
                ...
                <div class="rules__block">
                    <span class="rules__text"><?php the_field('description_PPR', 2); ?></br></br><a href='<?php echo get_page_link(13); ?>' style='text-decoration:underline'>Как с нами работать</a></span>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal__flexbox">
            ...
            <button type="submit" id="btn_send_main" class="modal__btn button btn-reset">Отправить</button>
          </form>
          <style>
            .modal__input {
  border: 1px solid #555555;
  box-shadow: 3px 4px 0px 0px #2A2D22;
  -webkit-box-shadow: 3px 4px 0px 0px #2A2D22;
-moz-box-shadow: 3px 4px 0px 0px #2A2D22;
            }
          </style>
